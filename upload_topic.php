  ...
  <!-- Sidebar -->
    ...
    <form action="upload.php" enctype="multipart/form-data" method="post">
        <div class="form-group">
            <label class="font-weight-bold">Topic Title:</label>
            <input type="text" class="form-control" placeholder="Enter topic name here" name="TopicName">
        </div>
        <div class="form-group">
        ...
        <p class="font-weight-bold">Topic icon:</p>
        <input type="file" name="Filename">
        <div class="mt-3">
            <button type="submit" class="btn btn-primary" name="upload" onClick="alertbox()">Submit</button>
        </div>
